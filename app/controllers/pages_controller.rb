class PagesController < ApplicationController
  ...
  def home
      ...
      @images = Blob.all
      @blob = Blob.new
  	  @posts = Post.where("posts.parent_id is NULL and (posts.posted_to_id is NULL or posts.posted_to_id = ?) and posts.posted_by_id != ?", current_user.u_id ,current_user.u_id)
